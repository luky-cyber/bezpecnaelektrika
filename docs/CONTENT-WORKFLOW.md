...
## Odborné guardrails v0.5.13

- Hliníkový vodič nie je sám osebe verdikt o bezpečnosti ani automatický dôvod na kompletnú výmenu elektroinštalácie. Odborný text má rozlišovať materiál vodiča, stav spojov a prvkov, zásahy, prehliadku, skúšanie a meranie.
- Pri Al/Cu spojeniach nevytvárať univerzálny realizačný návod. Vhodnosť konkrétneho spojovacieho prvku sa overuje podľa jeho výrobcu, určenia, materiálov a prierezov.
- `nulák` je iba discovery/related term. Nesmie byť použitý ako synonymný alias pre PEN.
- RCD je zastrešujúci pojem; RCCB a RCBO sa na webe zobrazujú iba ako vybrané relevantné typy, nie ako úplná taxonómia všetkých RCD.
- Odbornú správnosť týchto formulácií kontrolovať redakčne. Validator má strážiť iba deterministické invarianty a nemá nahrádzať odborný review string-matchingom.
